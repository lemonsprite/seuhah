    ...
    <div class="h-screen w-full flex overflow-hidden">
        <nav class="flex flex-col bg-gray-200 dark:bg-gray-900 w-64 px-12 pt-4 pb-6">
            ...
            <ul class="mt-2 text-gray-600">
                ...
                <li class="mt-8">
                    <a href="#home" class="flex items-center">
                        <i class="fas fa-chart-pie p-2"></i>
                        <span class="ml-2 capitalize font-medium">Pesanan</span>
                    </a>
                </li>
            ...
            <div class="mx-10 my-2">
				...
				dark:bg-gray-600 shadow-xl rounded-lg cursor-pointer ">
                    ...
                    <div class="flex justify-between">
                        ...
                        <img class="h-12 w-12 rounded-full object-cover"
                            src="https://inews.gtimg.com/newsapp_match/0/8693739867/0" alt="" />
				...
				dark:bg-gray-600 shadow-xl rounded-lg cursor-pointer">
                    ...
                    <div class="flex justify-between">
                        ...
                        <img class="h-12 w-12 rounded-full object-cover"
                            src="https://www.hdwallpapers.in/download/2012_darksiders_ii-1920x1080.jpg" alt="" />
