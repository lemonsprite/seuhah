    ...
    <div class="navbar h-16 fixed top-0 w-full text-white transition-all transition-75">
        <div class="lg:container m-auto flex items-center justify-between h-full px-10">
            ...
            <div class="user flex relative">
                <button onclick="cart_open()" class="h-auto w-auto px-4 bg-blue-500 flex items-center justify-center mr-5 rounded-md relative text-white focus:outline-none">
                ...
                <button onfocus="pic_drop()" onblur="pic_drop()" class="pic focus:outline-none rounded-full truncate w-10 h-10 border border-white">
                    <img src="<?= base_url('assets/img/pic.jpg'); ?>" height="40">
                </button>
                <div class="dropdown bg-white shadow-md text-black absolute top-full mt-2 rounded-md right-0 py-3 px-4 hidden">
                    <ul class="text-left">
                        <li>
                            <a href="#" class="py-2 px-3 flex items-center hover:bg-gray-200 rounded-md">
