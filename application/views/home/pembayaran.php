        ...
        <div class="col-lg-8 col-md-8 mx-auto py-4">
            <div class="container text-center pt-10">
                ...
                <div class="detail mt-5">
                    <h4 class="pt-5 fs-1">Berhasil Membuat Pesanan!</h4>
                    <h5>Silahkan lakukan pembayaran dan upload bukti pesanan!</h5>
                    <h6 class="text-danger">Pesanan akan hangus setelah 8 jam.</h6>
                    ...
                    <a href="<?= base_url('home') ?>" class='btn btn-primary mt-5'>Kembali ke Home</a>
                </div>
            </div>
        </div>
    </section>
